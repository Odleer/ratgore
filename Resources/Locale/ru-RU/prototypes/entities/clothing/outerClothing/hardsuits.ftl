...
ent-ClothingOuterHardsuitSyndieMedic = NCSP mk.IV "Zhongyao" tacsuit
    .desc =
        A tactical stealth combat hardsuit produced by the Cyberdawn-Technologies Corporation, the suit's tags indicate it provides moderate protection against most forms of damage.
...
ent-ClothingOuterHardsuitCybersunStealth = CDT mk.I "Èguǐ" tacsuit
    .desc =
        A rare prototype tacsuit produced by the Cyberdawn-Technologies Corporation that features metamaterial plating which warps light around it to produce an "Invisibility cloak" effect.
